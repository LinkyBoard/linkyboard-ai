    ...
    async def generate_youtube_summary(
        ...
        **kwargs
        ...
        try:
            ...
            prompt = f"""
            YouTube 비디오를 분석하여 한국어로 요약해주세요.
            
            특별 지시사항:
            - 자막이 어떤 언어로 되어 있든 반드시 한국어로 요약해야 합니다
            - 영어, 일본어, 중국어, 스페인어 등 모든 언어의 자막을 이해하고 한국어로 변환해주세요
            - 3-5문장의 자연스러운 한국어 요약을 작성해주세요
            - 동영상의 주요 내용, 핵심 메시지, 중요한 정보를 모두 포함해주세요
            ...
            ⚠️ 필수: 위 내용을 완전히 이해한 후 반드시 한국어로만 요약해주세요. 영어나 다른 언어 사용 금지.
            """
